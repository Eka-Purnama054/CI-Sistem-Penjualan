                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <?php } ?>
                                        <form action="<?php echo base_url(); ?>index.php/datasuplier/updatedata" method="post">
                                            ...
                                            <div class="form-group">
                                                <p>
                                                    ...
                                                    Tidak menerima sms kode otp? <a href="<?= base_url('index.php/datasuplier/kirimulang') ?>">kirim ulang</a><br>
                                                    <a href="<?= base_url(); ?>index.php/datasuplier">Kembali</a>
                                                </p>
                                            </div>
                                        </form>
