                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <?php } ?>
                                        <form action="<?php echo base_url(); ?>index.php/coa/hapuscoa" method="post">
                                            ...
                                            <div class="form-group">
                                                <p>
                                                    ...
                                                    Tidak menerima sms kode otp? <a href="<?php echo base_url('index.php/coa/kirimulangkode') ?>">kirim ulang</a><br>
                                                    <a href="<?= base_url(); ?>index.php/coa">Kembali</a>
                                                </p>
                                            </div>
                                        </form>
