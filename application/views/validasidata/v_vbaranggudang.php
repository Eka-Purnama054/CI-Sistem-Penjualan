                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <?php } ?>
                                        <form action="<?php echo base_url(); ?>index.php/baranggudang/updatedata" method="post">
                                            ...
                                            <div class="form-group">
                                                <p>
                                                    ...
                                                    Tidak menerima sms kode otp? <a href="<?php echo base_url('index.php/baranggudang/kirimulang') ?>">kirim ulang</a><br>
                                                    <a href="<?= base_url(); ?>index.php/baranggudang">Kembali</a>
                                                </p>
                                            </div>
                                        </form>
