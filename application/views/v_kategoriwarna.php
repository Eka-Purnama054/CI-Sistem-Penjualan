                ...
                <div class="content">
                    <div class="page-inner">
                        <div class="page-header">
                            <h4 class="page-title">DataWarna</h4>
                            <ul class="breadcrumbs">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url(); ?>index.php/kategoriwarna">DataWarna</a>
                                </li>
                                <li class="separator">
                                    <i class="flaticon-right-arrow"></i>
                                </li>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form method="post" action="<?= base_url(); ?>index.php/kategoriwarna/insert">

                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group form-group-default">
                                                                        <label>Nama Warna</label>
                                                                        <input id="nama" name="nama" type="text" class="form-control" placeholder="name Warna" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    </div>
                                            ...
                                            <div class="modal fade" id="modalEdit<?= $id ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <?php echo $this->session->flashdata('msg'); ?>
                                                            <form method="post" action="<?php echo base_url(); ?>index.php/kategoriwarna/update">
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group form-group-default">
                                                                            <label>ID. Warna</label>
                                                                            <input id="id" name="id" value="<?= $id ?>" type="text" class="form-control" placeholder="id warna" readonly>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group form-group-default">
                                                                            <label>Nama Warna</label>
                                                                            <input id="namakategori" name="namakategori" value="<?= $nm ?>" type="text" class="form-control" placeholder="name warna" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        </div>
                                            ...
                                            <div class="modal fade" id="modalEdit<?= $id ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <?php echo $this->session->flashdata('msg'); ?>
                                                            <form method="post" action="<?php echo base_url(); ?>index.php/kategoriwarna/ownerupdate">
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group form-group-default">
                                                                            <label>ID. Warna</label>
                                            ...
                                            <div id="modalHapus<?= $id ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/kategoriwarna/delete">
                                                            <div class="modal-body">
