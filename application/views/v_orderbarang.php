                ...
                <div class="content">
                    <div class="page-inner">
                        <div class="page-header">
                            <h4 class="page-title">OrderBarang</h4>
                            <ul class="breadcrumbs">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url(); ?>index.php/orderbarang">OrderBarang</a>
                                </li>
                            </ul>
                        </div>
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="d-flex align-items-center">
                                            <h4 class="card-title"><i class="flaticon-cart-1"></i> Order Barang</h4>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    ?>
                                                                        <tr>
                                                                            ...
                                                                            <td><?= $size ?></td>
                                                                            <td><?= $stok ?></td>
                                                                            <form action="<?php echo base_url(); ?>index.php/orderbarang/order" method="post">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php foreach ($this->cart->contents() as $items) : ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align:center;">
                                                                        <a href="<?= base_url('index.php/orderbarang/removeorder/' . $items['rowid']); ?>" class="btn btn-link btn-primary" data-original-title=".Remove"><span class="fas fa-trash"></a>
                                                                    </td>
                                                                </tr>
                                                                <?php $i++; ?>
                                                            <?php endforeach; ?>
                                                    ...
                                                    <form action="<?= base_url(); ?>index.php/orderbarang/simpanorder" method="POST">
                                                        ...
                                                        <div class="form-group">
                                                            <button type="submit" class="btn btn-primary"><span class="fas fa-archive"></span> Simpan</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                ...
                <div class="content">
                    <div class="page-inner">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumbs">
                                <li class="nav-home">
                                    <a href="<?= base_url(); ?>index.php/homeaadmin">
                                        <i class="flaticon-home"></i>
                                    </a>
                                </li>
                                <li class="separator">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input name="no_order" type="text" class="form-control" value="<?= $kodeakt ?>" placeholder="No_Order..." aria-label="Noorder" aria-describedby="basic-addon1">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <form action="<?php echo base_url(); ?>index.php/orderbarang/order" method="post">
                                                                                ...
                                                                                <td style="text-align:center;">
                                                                                    ...
                                                                                    <input type="hidden" name="stok" value="<?= $stok; ?>">
                                                                                    <input type="hidden" name="harjul" value="<?= number_format($harjul); ?>">
                                                                                    <button type="submit" class="btn btn-link btn-primary" data-original-title=".Pilih" target="_blank"><span class="fas fa-luggage-cart"></span></button>
                                                                                </td>
                                                                            </form>
                                                                        </tr>
                                                                    <?php endforeach; ?>
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <form action="<?= base_url(); ?>index.php/orderbarang/simpanorder" method="POST">
                                                        <div class="form-group col-md-4 has-success">
                                                            ...
                                                            <textarea name="pesan" class="form-control" id="comment" rows="5"></textarea>
                                                            <input type="hidden" name="total" id="total" value="<?php echo $this->cart->total(); ?>">
                                                            <input name="no_order" type="hidden" class="form-control" value="<?= $kodeakt ?>" placeholder="No_Order..." aria-label="Noorder" aria-describedby="basic-addon1">
                                                        </div>
                                                        <div class="form-group">
                                                            <button type="submit" class="btn btn-primary"><span class="fas fa-archive"></span> Simpan</button>
                                                        </div>
