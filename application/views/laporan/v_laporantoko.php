                ...
                <div class="content">
                    <div class="page-inner">
                        <div class="page-header">
                            <h4 class="page-title">TransaksiPenjualan</h4>
                            <ul class="breadcrumbs">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url(); ?>index.php/laporan"></i>TransaksiPenjualan</a>
                                </li>
                                <li class="separator">
                                    <i class="flaticon-right-arrow"></i>
                                </li>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <form action="<?= base_url(); ?>index.php/laporan/lappentokoadmin" target="_blank" method="POST">
...
<?php if ($this->session->userdata('lvl') == 'Admin' || $this->session->userdata('lvl') == 'Gudang') { ?>
    <!DOCTYPE html>
    <html lang="en">
		...
		-->
            ...
            <div class="main-panel">
                <div class="content">
                    <div class="page-inner">
                        <div class="page-header">
                            <h4 class="page-title">LaporanPenjualan/Toko</h4>
                            <ul class="breadcrumbs">
                                <li class="nav-home">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url(); ?>index.php/laporan"></i>PenjualanToko</a>
                                </li>
                                <li class="separator">
                                    <i class="flaticon-right-arrow"></i>
                                </li>
