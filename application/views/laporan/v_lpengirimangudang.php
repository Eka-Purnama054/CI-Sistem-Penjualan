                    ...
                    <div class="page-inner">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumbs">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url(); ?>index.php/lpengiriman/lihatdatastokingudang">Pengiriman Dari Suplier</a>
                                </li>
                                <li class="separator">
                                    <i class="flaticon-right-arrow"></i>
                                </li>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="<?= base_url(); ?>index.php/lpengiriman/cetakdarisuplier" target="_blank" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="suplier" id="suplier" class="form-control">
                                                    ...
                                                    <?php foreach ($suplier as $a) :  ?>
                                                        <option value="<?= $a->id_suplier ?>"><?= $a->nama_suplier ?>-<?= $a->alamat_suplier ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h4> <b> CETAK SURAT JALAN DARI SUPLIER </b></h4>
                                    </div>
                                    <div class="card-body">
                                        <form action="<?= base_url(); ?>index.php/lpengiriman/cetaksjsuplier" method="POST">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="nokirim" id="nokirim" placeholder="Nomor Kirim" required>
                                                    ...
                                                    <?php foreach ($nokrm as $a) :  ?>
                                                        <option value="<?= $a->kode_stokin ?>"><?= $a->kode_stokin ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="add-row" class="display table table-striped table-hover">
                                                ...
                                                <tbody>
                                                    <?php $no = 0;
                                                    foreach ($krmg->result_array() as $b) :
                                                        $no++;
                                                        $id = $b['kode_stokin'];
                                                        $nm = $b['nama_barang'];
                                                        $kode = $b['kode_barang'];
