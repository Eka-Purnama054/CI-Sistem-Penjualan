    ...
    <div class="wrapper">
        ...
        <table border="0" align="center" style="width:900px;border:none;">
            <tr>
                ...
                <th style="text-align:left;width:300px">: <?php echo $b['no_stokin']; ?></th>&nbsp;
            </tr>
            <tr>
                <th style="text-align:left;">Tanggal</th>
                <th style="text-align:left;">: <?php echo $b['tgl_stokin']; ?></th>
            </tr>
            <tr>
                <th style="text-align:left;">No. Po </th>
                <th style="text-align:left;">: <?= $b['kode_order'] ?></th>
            </tr>
        </table>
        <div class="row">
            <table border="0" align="center" style="width:900px;border:none;">
