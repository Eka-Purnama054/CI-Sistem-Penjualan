            ...
            <div class="content">
                <div class="page-inner">
                    <div class="page-header">
                        <h4 class="page-title">LaporanPenjualan/Kasir</h4>
                        <ul class="breadcrumbs">
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url(); ?>index.php/laporan/laptokoperkasir"></i>PenjualanKasir</a>
                            </li>
                            <li class="separator">
                                <i class="flaticon-right-arrow"></i>
                            </li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <form action="<?= base_url(); ?>index.php/laporan/lpenjkasir" target="_blank" method="POST">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?= $barang_nama ?></td>
                                                            <td><?= $size ?></td>
                                                            <td>Rp. <?= number_format("$barang_harjul", 2, ",", ".") ?></td>
                                                            <td><?= $barang_qty ?></td>
