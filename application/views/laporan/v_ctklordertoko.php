        ...
        <table border="1" align="center" style="width:900px;margin-bottom:20px;">
            <thead>
                <tr>
                    ...
                    <th style="width:90px;border:none;text-align:center;">Dikirim/Belum</th>
                    <th style="width:90px;border:none;text-align:center;">Tanggal Kirim</th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;"><?php echo $kirim; ?></td>
            ...
            <tfoot>
                ...
                <tr>
                    ...
                    <td style="text-align:right;">
                        <b><?php echo 'Rp ' . number_format($b['total_order']) . ',-'; ?>
                        </b>
                    </td>
                </tr>
            </tfoot>
