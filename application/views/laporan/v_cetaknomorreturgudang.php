...
<body onload="window.print()">
    <div class="wrapper">
        ...
        <table border="0" align="center" style="width:800px; border:none;margin-top:5px;margin-bottom:0px;">
            <tr>
                ...
                <th colspan="2" style="width:800px;padding-left:20px;">
                    ...
                    <h4><?= $b['alamat_suplier'] ?> / <?= $b['no_telp'] ?></h4>
                </th>
            </tr>
        </table>
        ...
        <table border="0" align="center" style="width:900px;border:none;">
            <tr>
                <th style="text-align:left;">Nomor Retur </th>
                <th style="text-align:left;">: <?php echo $b['no_retur']; ?></th>&nbsp;
            </tr>
            <tr>
                <th style="text-align:left;">Tanggal</th>
                <th style="text-align:left;">: <?php echo $b['tanggal_retur']; ?></th>
            </tr>
        </table>
        <div class="row"></div>
        <table border="0" align="center" style="width:900px;border:none;">
        ...
        <table border="1" align="center" style="width:900px;border:none;">
            ...
            <tbody>
                <?php
                $no = 0;
                foreach ($nomor->result_array() as $i) {
                    $no++;
                    $kode = $i['kode_barang'];
                    $item = $i['nama_item'];
                    $size = $i['nama_size'];
        ...
        <table align="center" style="width:800px; border:none;margin-top:5px;margin-bottom:20px;">
            ...
            <tr>
                ...
                <td align="right">( <?php echo $b['name']; ?> )</td>
            </tr>
            <tr>
                <td align="center"></td>
            </tr>
