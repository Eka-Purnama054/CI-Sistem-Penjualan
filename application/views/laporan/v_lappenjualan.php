            ...
            <div class="content">
                <div class="page-inner">
                    <div class="page-header">
                        <h4 class="page-title">LaporanPenjualan</h4>
                        <ul class="breadcrumbs">
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url(); ?>index.php/laporan/lpenjualantoko"></i>Penjualan</a>
                            </li>
                            <li class="separator">
                                <i class="flaticon-right-arrow"></i>
                            </li>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <form action="<?= base_url(); ?>index.php/laporan/lappentanggal" target="_blank" method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <h4><b>CETAK STRUK</b></h4>
                                </div>
                                <div class="card-body">
                                    <form action="<?= base_url(); ?>index.php/laporan/cetak_struk" method="POST">
                                        <div class="form-group">
                                            <label for="exampleFormControlSelect1">Nomor Transaksi</label>
                                            <select name="nofaktur" class="form-control" id="exampleFormControlSelect1">
                                                <option>&nbsp;</option>
                                                <?php foreach ($nomor as $row) : ?>
                                                    <option value="<?= $row->no_faktur ?>"><?= $row->no_faktur ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        <h4 class="card-title">DataTransaksi</h4>
