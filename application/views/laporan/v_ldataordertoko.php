            ...
            <div class="content">
                <div class="page-inner">
                    <div class="page-header">
                        <h4 class="page-title">LaporanOrderBarang</h4>
                        <ul class="breadcrumbs">
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url(); ?>index.php/laporan/lorderbarangt"></i>Order</a>
                            </li>
                            <li class="separator">
                                <i class="flaticon-right-arrow"></i>
                            </li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <form action="<?= base_url(); ?>index.php/laporan/lpertanggalorder" target="_blank" method="POST">
