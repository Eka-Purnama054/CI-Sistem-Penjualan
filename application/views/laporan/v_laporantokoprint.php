...
<body onload="window.print()">
    <div class="wrapper">
        ...
        <table border="1" align="center" style="width:900px;border:none;margin-bottom:20px;">
            <thead>
                <tr>
            ...
            <tbody>
                <?php
                $no = 0;
                foreach ($laptoko->result_array() as $i) {
                    $no++;
                    $nofak = $i['no_faktur'];
                    $tgl = $i['tanggal'];
