                ...
                <div class="content">
                    <div class="page-inner">
                        <div class="page-header">
                            <h4 class="page-title">DataSize</h4>
                            <ul class="breadcrumbs">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url(); ?>index.php/kategorisize">Size</a>
                                </li>
                                <li class="separator">
                                    <i class="flaticon-right-arrow"></i>
                                </li>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form method="post" action="<?= base_url(); ?>index.php/kategorisize/insert">
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group form-group-default">
                                                                        <label>Size Barang</label>
                                                                        <input id="nama" name="nama" type="text" class="form-control" placeholder="Size Barang" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    </div>
                                        ...
                                        <!-- Modal Edit -->
                                        <?php $no = 1;
                                        foreach ($size->result_array() as $b) {
                                            $no++;
                                            $id = $b['id_size'];
                                            $nm = $b['nama_size'];
                                            $create = $b['created_at'];
                                            ...
                                            <div class="modal fade" id="modalEdit<?= $id ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <?php echo $this->session->flashdata('msg'); ?>
                                                            <form method="post" action="<?php echo base_url(); ?>index.php/kategorisize/updateowner">
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group form-group-default">
                                                                            <label>ID. Size</label>
                                                                            <input id="id" name="id" value="<?= $id ?>" type="text" class="form-control" placeholder="ID. Size" readonly>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group form-group-default">
                                                                            <label>Size Barang</label>
                                                                            <input id="nama" name="nama" value="<?= $nm ?>" type="text" class="form-control" placeholder="Size Barang" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        </div>
                                            ...
                                            <div id="modalHapus<?= $id ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/kategorisize/delete">
                                                            <div class="modal-body">
                                            ...
                                            <div class="modal fade" id="modalEdit<?= $id ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <?php echo $this->session->flashdata('msg'); ?>
                                                            <form method="post" action="<?php echo base_url(); ?>index.php/kategorisize/update">
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group form-group-default">
                                                                            <label>ID. Size</label>
